...
extension CoreViewController {
    ...
    func handleLightningAddressNotification(_ notification: BittrNotification) {
        ...
        if !self.userHasSignedIn {
            ...
            self.showAlert(id: TestID.Alert.paymentRequest, title: Language.getWord(withID: "paymentrequest"), message: Language.getWord(withID: "paymentrequest2").replacingOccurrences(of: "<amount>", with: String(notification.amountMsat!/1000).addSpaces()), buttons: [.dismiss(Language.getWord(withID: "okay"))])
    ...
    func handleLightningAddressNotificationImmediately() {
        ...
        guard
            ...
            self.showAlert(id: TestID.Alert.paymentRequestFailed, title: Language.getWord(withID: "paymentrequest"), message: Language.getWord(withID: "paymentrequestfailed2"), buttons: [.dismiss(Language.getWord(withID: "close"))])
            return
        }
        ...
        Task {
            ...
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    self.showAlert(id: TestID.Alert.paymentRequestFailed, title: Language.getWord(withID: "paymentrequestfailed"), message: Language.getWord(withID: "paymentrequestfailed2"), buttons: [.dismiss(Language.getWord(withID: "okay"))])
                }
                return
            }
