...
class Language: NSObject {
    ...
    static func fromEnUS(withID:String) -> String {
        ...
        let allWords:[String:String] = [
            ...
            "questionvc1": "There's a limit to the amount of satoshis you can receive per invoice.\n\nThe size of your bitcoin lightning connection is <channelsize> satoshis. You've already received <channelbalance> sats, so you can still receive up to <receivelimit> sats in total.\n\nWhen the connection is full, we'll invite you to move your funds to your regular bitcoin wallet to make space for future transactions.",
            "questionvc6": "why can't I send instant payments?",
            "questionvc7": "Your bittr wallet consists of a bitcoin wallet (for regular payments) and a bitcoin lightning connection (for instant payments).\n\nYou've already received <channelbalance> satoshis into your lightning connection. Your lightning connection needs to contain a minimum of <channelreserve> sats, so the maximum amount you can send in total is <sendlimit> sats.\n\nWhen the connection is full, we invite you to empty its funds into your bitcoin wallet so that you have space again.",
            ...
            "paymentrequest3": "Someone wants to pay you <amount> satoshis! Accept now or try again later in Device Details.",
