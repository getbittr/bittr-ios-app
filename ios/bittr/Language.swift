...
class Language: NSObject {
    ...
    static func fromEnUS(withID:String) -> String {
        ...
        let allWords:[String:String] = [
            ...
            "closechannel5": "The connection closure has been initiated. This may take several minutes to complete on the blockchain. Please wait for your funds to reappear in your wallet, before removing your wallet definitively.",
