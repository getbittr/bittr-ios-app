...
class Language: NSObject {
    ...
    static func fromEnUS(withID:String) -> String {
        ...
        let allWords:[String:String] = [
            ...
            "enterinvoice": "Enter lightning address or invoice",
            "enteraddress": "Enter address",
            "enterbitcoinaddress": "Enter bitcoin address",
            "enteramount": "Enter amount",
            "wrongnetworkaddress": "This bitcoin address is for a different network. Please double-check it and try again.",
            "wrongnetworkinvoice": "This lightning invoice is for a different network. Please double-check it and try again.",
            "cannotpayself": "This invoice was created by your own wallet — you can't pay yourself.",
            "bolt12notsupported": "This type of lightning payment isn't supported yet. Please use a lightning invoice or address instead.",
            ...
            "onchainpayoutscheduled": "Payment Scheduled",
            "onchainpayoutscheduled2": "Your payment has been scheduled for on-chain delivery within 4-24 hours. You'll receive a notification when it's completed.",
            "onchainpayoutfail": "Failed to schedule on-chain payment: <message>",
            "walletnotsynced": "Wallet has not been synced.",
            ...
            "lnurlfail4": "We currently only support lightning pay and withdraw requests.",
            "sendvcscan": "Scan",
            "sendvcpaste": "Paste",
            "sendvctype": "Type",
            "language": "Language",
            ...
            "swapstatusclaiming": "Claiming your bitcoin",
            ...
            "invalidbitcoinaddress": "This doesn't look like a valid bitcoin address. Please double-check it and try again.",
            ...
            "handlinglnurl": "Handling lightning request",
            ...
            "OutputBelowDustLimit": "This amount is too small to send on-chain (below the dust limit). Please enter a larger amount.",
            ...
            "selecttransactiontype": "Share a lightning address or invoice, a bitcoin QR or address.",
            ...
            "mapvcpoweredbyalert": "<b>BTCMap.org</b> uses OpenStreetMap to tag places that accept bitcoin, and display those merchants in their beautiful apps.<br><br>Their apps and the underlying data are free and open-source.<br><br>Neither bittr nor BTCMap.org receives your location. Your phone downloads the whole list of places and picks out the nearby ones itself.<br><br>The map itself is drawn by a map provider, which sees the area on your screen — and if you allow location, that starts with the area around you."
