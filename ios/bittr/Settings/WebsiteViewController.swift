...
private extension URL {
    ...
    ///
    /// Case is preserved. Bech32 LNURLs are case-insensitive, but the https callbacks a
    /// `tag=login` navigation carries are not — lowercasing the whole URL, as this code
    /// used to, corrupts their path.
    var lnurlCode:String {
        self.absoluteString.replacingOccurrences(
            of: "lightning:",
            with: "",
