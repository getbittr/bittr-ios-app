...
class TransactionViewController: UIViewController {
    ...
    @IBAction func idButtonTapped(_ sender: UIButton) {
        ...
        self.showAlert(title: Language.getWord(withID: "copied"), message: self.tappedTransaction.id, buttons: [Language.getWord(withID: "okay")])
    }
    
    @IBAction func descriptionButtonTapped(_ sender: UIButton) {
        
        UIPasteboard.general.string = self.tappedTransaction.lnDescription
        self.showAlert(title: Language.getWord(withID: "copied"), message: self.tappedTransaction.lnDescription, buttons: [Language.getWord(withID: "okay")])
    }
