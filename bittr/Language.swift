...
class Language: NSObject {
    ...
    static func fromEnUS(withID:String) -> String {
        ...
        let allWords:[String:String] = [
            ...
            "lightninginsufficientfunds": "You don't have enough Lightning funds to send this payment.",
            "onchaininsufficientfunds": "You don't have enough onchain funds to send this payment. Your available onchain balance is",
            "swapinsufficientfunds": "However, you have enough regular Bitcoin funds to swap and pay. Your available onchain balance is",
            "swapandpay": "Swap & Pay",
