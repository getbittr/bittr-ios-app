...
class Language: NSObject {
    ...
    static func fromEnUS(withID:String) -> String {
        ...
        let allWords:[String:String] = [
            ...
            "lightningexplanation1": "To send and receive instant bitcoin payments, you need to have at least one lightning connection connection.\n\nTo open a connection with bittr, buy bitcoin worth up to 100 Swiss Francs or Euros to receive a lightning connection. Check your wallet's Buy section or getbittr.com for all information.",
            ...
            "closedlightningchannel2": "Your lightning connection has been closed.\n\nAny funds that were in this connection are deposited into your bitcoin wallet.\n\nTo open a new connection with bittr, buy bitcoin worth up to 100 Swiss Francs or Euros. Check your wallet's Buy section or getbittr.com for all information.",
            ...
            "lightninginsufficientfunds": "You don't have enough Lightning funds to send this payment. Your available Lightning balance is <amount> satoshis.",
