...
class Language: NSObject {
    ...
    static func fromEnUS(withID:String) -> String {
        ...
        let allWords:[String:String] = [
            ...
            "lightningconfirmation": "Are you sure you want to pay <amount> satoshis (<currency> <convertedamount>) for this invoice?\n\nThis payment may incur fees of up to <fees> satoshis.",
            ...
            "questionvc8": "satoshis into your lightning wallet. Your lightning channel needs to contain a minimum of",
            ...
            "restorewallet4": "Please close your Lightning channel(s) before restoring a wallet.\n\nRestoring a wallet means removing your wallet from this device, upon which you may lose access to the funds in your Lightning channel.",
            "closechannel": "Close channel",
            "closechannel2": "If you close your Lightning channel, its funds will be deposited back into your wallet.\n\nPlease wait for this transaction to show up, before definitively removing this wallet from your device.",
