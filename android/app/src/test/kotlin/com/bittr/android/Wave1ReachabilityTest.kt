...
class Wave1ReachabilityTest {
        ...
        composeRule.setContent {
            BittrTheme {
                HomePlaceholderScreen(
                    onOpenValue = { opened += "value" },
                    onOpenMap = { opened += "map" },
                    onOpenAcademy = { opened += "academy" },
                )
            }
        }
    ...
    fun `home's entry points are wired to the three routes`() {
        ...
        listOf(
            "onOpenValue" to "Routes.VALUE",
            "onOpenMap" to "Routes.MAP",
            "onOpenAcademy" to "Routes.ACADEMY",
