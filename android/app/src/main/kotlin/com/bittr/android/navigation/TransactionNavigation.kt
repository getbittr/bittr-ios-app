...
/**
 * Open a transaction after it completed — Send, a swap, or a payment arriving.
 *
 ...
 */
internal fun NavHostController.openTransaction(id: String) {
    ...
    navigate(Routes.transaction(id)) {
